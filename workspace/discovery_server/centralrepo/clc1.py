...
import httplib
import threading
cld_id = 'ens.aws-eu-frankfurt.edgenet.cloud'
...
#     data = {'clc_id': cld_id}
#     resp1 = requests.put(
#         "http://127.0.0.1:60678/api/v1.0/discover/heartbeat", params=data)
...
def heartbeat():
    ...
    print data
    resp1 = requests.put(
        "http://localhost:60678/api/v1.0/discover/heartbeat", params=data)
